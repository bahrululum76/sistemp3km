        ...
        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
            ...
            <tbody class="tbody">
                ...
                <tr class="thead">
                    ...
                    @if($p->foto !== null)
                    <img src="{{ 
                    asset('storage/kegiatan/'.$p->foto) }}" width="100px"/>
                    @else
                    ...
                    <td >
                        ...
                        <form id="delete-obat-{{$p->id}}" action=" {{ url('admin/kegiatan/delete'.$p->id) }}" method="post" style="display: inline" data-id="{{$p->id}}">
                            {{csrf_field()}}
                            {{method_field('delete')}}
...
<div id="EditModal-{{ $p->id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
            <form action="{{ url('admin/kegiatan/edit'.$p->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                    <label >Nama</label>
                        <input type="text" class="form-control" name="nama" value="{{$p->nama}}" required="required"  >
                  </div>

                  <div class="form-group">
                    <label >Detail</label>
                    <textarea class="ckeditor" id="ckeditor" name="detail" value="{{$p->detail}}" required="required">{{$p->detail}}</textarea>
                  </div>
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="foto"value="{{$p->foto}}">
                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                    </div>
                    </div>
