      ...
      <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
            ...
            <tbody class="tbody">
                ...
                <tr class="thead">
                    ...
                    <td>
                        <button   class="btn btn-primary btn-sm " data-toggle="modal" data-target="#ModalEdit-{{$p->id}}" value="">Ubah</button>
                        
                        
                        <form id="delete-obat-{{$p->id}}" action=" {{ url('admin/kelolapenelitian/delete'.$p->id) }}" method="post" style="display: inline" data-id="{{$p->id}}">
                            {{csrf_field()}}
                            {{method_field('delete')}}
...
<!-- Modal tambah -->
@foreach ($penelitian as $p)
<div id="ModalEdit-{{$p->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{ url ('admin/kelolapenelitian/edit'.$p->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
